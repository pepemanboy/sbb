...
bool Hc12Antenna::ConfigureParameter(char *query) {
  SBB_DEBUG(query);
...
bool Hc12Antenna::Setup(int channel) {
...
bool Hc12Antenna::SetupOneTime(int channel) {
...
bool Hc12Antenna::IsReadAvailable() { return serial_.available(); }
